...
config.General.requestName = 'MuOnia2017C_PR2_mini'
...
config.Data.inputDataset = '/MuOnia/Run2017C-PromptReco-v2/MINIAOD'
...
### patch for /Charmonium/Run2017C-PromptReco-v1/MINIAOD stored at T1_FR_CCIN2P3_Disk
#config.Data.ignoreLocality = True
